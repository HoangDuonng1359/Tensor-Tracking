...
from low_rank_extraction.common_v1 import DecompositionConfig
from low_rank_extraction.common_v1 import DecompositionResult
from low_rank_extraction.common_v1 import add_direction
from low_rank_extraction.common_v1 import concatenate_mode_unfoldings
from low_rank_extraction.common_v1 import compute_intervals
from low_rank_extraction.common_v1 import config_to_dict
from low_rank_extraction.common_v1 import convert_subject_tensor_to_stream
from low_rank_extraction.common_v1 import delete_direction
from low_rank_extraction.common_v1 import ensure_symmetric
from low_rank_extraction.common_v1 import gtcs_s_recovery
from low_rank_extraction.common_v1 import project_orthogonal
from low_rank_extraction.common_v1 import reconstruct_from_bases
from low_rank_extraction.common_v1 import result_to_legacy_layout
from low_rank_extraction.common_v1 import save_result_bundle
from low_rank_extraction.common_v1 import soft_threshold
from low_rank_extraction.common_v1 import truncated_basis
from low_rank_extraction.common_v1 import unfold_tensor
...
def save_condition_outputs(condition: str, result: DecompositionResult) -> None:
  ...
  savemat(config.paths.FCCA_DIR / f"horls_results_{condition}.mat", {
